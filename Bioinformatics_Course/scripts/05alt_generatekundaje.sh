...
echo "bds atac.bds -species dm6 -species_file ~/bio/lillyl1/ATACseq/KundajePipelineRefs/ -nth 8 -bwt2_idx /bio/lillyl1/ATACseq/KundajePipelineRefs/dm6/bowtie2_index/dm6.fa -fastq1_1 ${prefix}_F.fq.gz -fastq1_2 ${prefix}_R.fq.gz -out_dir /bio/lillyl1/ATACseq/processed_data/$(basename $prefix) -gensz dm -chrsz /bio/lillyl1/ATACseq/KundajePipelineRefs/dm6/dm6.chrom.sizes -no_ataqc TRUE -title $(basename $prefix)" >>kundaje_atac_code.txt
